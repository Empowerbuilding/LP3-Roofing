    ...
    <section ref={ref as React.RefObject<HTMLElement>} className="py-20" style={{ background: "#111" }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-10">
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 font-bold px-8 py-4 text-base uppercase tracking-wide transition-all duration-200 btn-dark" style={{ background: "#111", color: "#fff" }}
          >
