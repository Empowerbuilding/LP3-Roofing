    ...
    <section ref={ref as React.RefObject<HTMLElement>} className="py-20" style={{ background: "#f0f0f0" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <p className="font-display reveal text-gray-950 text-xs font-bold uppercase tracking-[4px] mb-3">Recent Roofing Projects</p>
          <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-gray-950 mb-3">Our Work Speaks For Itself</h2>
          <Link href="/gallery" className="text-gray-500 hover:text-gray-900 text-sm underline underline-offset-4 transition-colors duration-200">
            View Our Gallery →
          </Link>
        </div>
        ...
        <div className="text-center mt-10">
          <Link
            href="/gallery"
            className="inline-flex items-center gap-2 px-8 py-3 font-bold text-sm uppercase tracking-wide transition-all duration-200 btn-dark" style={{ background: "#111", color: "#fff", border: "2px solid #111" }}
          >
            View Full Gallery
          </Link>
        </div>
