...
export default function HeroForm() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-8">
      {/* Review badges */}
      <div className="flex items-stretch divide-x divide-gray-200 mb-6">
        {/* Google */}
        <div className="flex flex-col items-center gap-1 flex-1 px-2">
          ...
          <span className="text-xs font-semibold text-gray-700">5.0 Rating</span>
        </div>
        {/* Facebook */}
        <div className="flex flex-col items-center gap-1 flex-1 px-2">
        ...
        {/* Yelp */}
        <div className="flex flex-col items-center gap-1 flex-1 px-2">
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#FF1A1A" xmlns="http://www.w3.org/2000/svg">
