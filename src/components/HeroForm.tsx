...
export default function HeroForm() {
  ...
  const inputClass = "w-full border border-gray-300 rounded-lg px-4 py-2.5 text-gray-950 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition text-sm"

  return (
    <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
      {/* Header bar */}
      <div className="bg-orange-500 px-6 py-3 text-center">
        <h2 className="text-4xl font-bold text-white">Get a Free Estimate Today!</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="px-4 py-4 sm:px-6 sm:py-5 flex flex-col gap-3">
        ...
        <button
          ...
          className="w-full bg-orange-500 hover:bg-orange-600 disabled:bg-orange-300 text-white font-bold py-3 rounded-lg transition-colors duration-200"
        >
