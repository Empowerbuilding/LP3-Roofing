  ...
  if (status === 'success') {
    return (
      <div className="bg-white rounded-2xl shadow-2xl p-8 text-center">
        ...
        className="font-display text-xl font-bold text-gray-950 mb-2">We&apos;ll be in touch!</h3>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
      ...
      <div className="bg-gray-900 px-6 py-3 text-center">
        className="font-display text-4xl font-bold text-white">Get a Free Estimate Today!</h2>
      </div>
